<div id="uploadSubject" class="fixed inset-0 bg-black/40 hidden">
    <div class="h-full flex items-center justify-center">
        <div class="bg-white rounded-lg w-1/3 p-6">
            <h2 class="text-xl font-semibold text-gray-800 mb-4">Upload Data Mata Pelajaran</h2>
            <!-- Formulir Tambah Data -->
            <form action="/admin/subject/upload" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="mb-5 ">
                    ...
                    <a href="/admin/subject/template/donwload"
                ...
                <div class="flex justify-end">
                    <button type="button" onclick="uploadSubject()"
