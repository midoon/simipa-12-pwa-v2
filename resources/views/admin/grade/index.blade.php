<x-layout title="Kelas | Admin">
    <x-navbar-admin>
        ...
        <header class="flex items-center justify-between">
            <h1 class="text-3xl font-semibold">Data Kelas </h1>
                            ...
                            <tr class="bg-simipa-6  ">
                                ...
                                <td class="px-6 py-4">
                                    <a class="hover:cursor-pointer hover:text-blue-500"
                                        href="/admin/group?grade_id={{ $grade->id }}">Daftar Rombel➡️</a>
                                </td>
                                <td class="px-1 py-4">
                                    <div class="flex gap-3">
                                        ...
                                        <form action="/admin/grade/{{ $grade->id }}" method="POST">
                                            ...
                                            <button type="submit" onclick="return confirmDeletion()">
                                                <svg class="w-6 h-6 text-gray-800 hover:text-red-700" aria-hidden="true"
