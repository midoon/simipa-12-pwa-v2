<div id="uploadTeacher" class="fixed inset-0 bg-black/40 hidden">
    <div class="h-full flex items-center justify-center">
        <div class="bg-white rounded-lg w-1/3 p-6">
            <h2 class="text-xl font-semibold text-gray-800 mb-4">Upload Data Guru</h2>
            ...
            <form action="/admin/teacher/upload" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-5 ">
                    ...
                    <a href="/admin/teacher/template/donwload"
                ...
                <div class="flex justify-end">
                    <button type="button" onclick="uploadTeacher()"
